...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HousePlant" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HousePlant.sqlite"];
//    
//    NSError *error = nil;
